<%-- 
    ...
    Created on : 24/09/2022, 12:53:46 p. m.
    Author     : jd754
--%>
...
<html>
        ...
        <!-- Template Main CSS File -->
          ...
          <script src="../../assets/js/Eliminar.js" type="text/javascript"></script>
    ...
    <center>
        ...
        <%
            ...
            listaProducto = ctrProductos.listar();
    ...
    <tr>
        ...
        <td><%=listaProducto.get(i).getDescripcionProducto()%></td>
        <td>
            <a href="actualizarProducto.jsp?idProducto=<%=listaProducto.get(i).getIdProducto()%>"><button class="btn btn-danger" >Actualizar</button></a>
            <button class="btn btn-danger" name="btnAccion=Eliminar" onclick="eliminar(<%=listaProducto.get(i).getIdProducto()%>)" > Eliminar</button>  
            </td>
        </tr>
        <% } %>
        </table>

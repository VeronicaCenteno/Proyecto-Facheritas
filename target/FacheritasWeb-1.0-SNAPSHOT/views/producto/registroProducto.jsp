<%-- 
    ...
    Created on : 24/09/2022, 12:47:00 p. m.
    Author     : jd754
--%>
...
<head>
    ...
    <title>Facheritas - Registro Producto</title>
  ...
  <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
    ...
    <nav id="navbar" class="navbar order-last order-lg-0">
      <ul>
          ...
          <li><a class="nav-link scrollto active" href="listarProducto.jsp"><h6>Consultar Producto</h6></a></li>
      </ul>
...
<div class="container">
 ...
 <div class="section-title">
	...
	<div class="row">
			<h4 style="color: white;">Ingresa los datos del producto correctamente</h4>
	</div>
	<div class="row input-container">
			...
			<div class="col-md-6 col-sm-12">
				<div class="styled-input">
					...
					<label style="left: 60px">Precio</label> 
				</div>
			</div>
			<div class="col-md-6 col-sm-12">
				<div class="styled-input" style="float:right;">
                                    <input type="text" name="categoriaProducto" required />
					<label style="left: 60px">Categoria</label> 
				</div>
			</div>
			<div class="col-xs-12">
				<div class="styled-input wide">
                                    <input type="name" name="descripcionProducto" required />

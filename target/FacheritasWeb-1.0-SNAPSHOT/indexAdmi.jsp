<%-- 
    Document   : indexUsu
    Created on : 25/09/2022, 8:07:17 p. m.
    Author     : jd754
--%>
...
<html>
    ...
    <html lang="en">
        ...
        <head>
            ...
            <title>Facheritas-Usuario</title>
                ...
                <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
                    ...
                    <nav id="navbar" class="navbar order-last order-lg-0">
                        <ul>
                            ...
                            <li><a class="nav-link scrollto" href="views/cliente/listarCliente.jsp">Consultar Cliente</a></li>
                            <li><a class="nav-link scrollto" href="views/usuario/registroUsuario.jsp">Registro Usuario</a></li>
                            <li><a class="nav-link scrollto" href="views/producto/registroProducto.jsp">Registro Producto</a></li>
                        </ul>

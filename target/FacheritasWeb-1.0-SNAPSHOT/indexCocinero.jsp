<%-- 
    Document   : indexCocinero
    Created on : 29/09/2022, 2:49:05 p. m.
    Author     : jd754
--%>
...
<html>
    ...
    <html lang="en">
        ...
        <head>
            ...
            <title>Facheritas-Cocinero</title>
                ...
                <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
                    ...
                    <nav id="navbar" class="navbar order-last order-lg-0">
                        <ul>
                            ...
                            <li><a class="nav-link scrollto" href="views/pedido/listarPedidos.jsp">Consultar Pedido</a></li>
                            <li><a class="nav-link scrollto" href="views/usuario/listarUsuario.jsp">Consultar Usuario</a></li>
                        </ul>
